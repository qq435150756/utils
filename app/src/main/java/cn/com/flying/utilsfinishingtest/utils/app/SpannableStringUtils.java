...
public class SpannableStringUtils {
     ...
     *
     * @param text 样式字符串文本
     * @return {@link SpannableStringUtils.Builder}
     */
    ...
    public static class Builder {
         ...
         * @return {@link SpannableStringUtils.Builder}
         */
        public SpannableStringUtils.Builder setForegroundColor(@ColorInt int color) {
         ...
         * @return {@link SpannableStringUtils.Builder}
         */
        public SpannableStringUtils.Builder setBackgroundColor(@ColorInt int color) {
         ...
         * @return {@link SpannableStringUtils.Builder}
         */
        public SpannableStringUtils.Builder setQuoteColor(@ColorInt int color) {
         ...
         * @return {@link SpannableStringUtils.Builder}
         */
        public SpannableStringUtils.Builder setAlign(@Nullable Layout.Alignment align) {
            this.align = align;
            return this;
        }
         ...
         * @return {@link SpannableStringUtils.Builder}
         */
        public SpannableStringUtils.Builder setBlur(float radius, BlurMaskFilter.Blur style) {
            this.radius = radius;
            this.style = style;
            this.isBlur = true;
            return this;
